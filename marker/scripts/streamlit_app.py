"""
Streamlit приложение для интерактивной конвертации документов.

Веб-интерфейс на основе Streamlit для удобной конвертации документов
с возможностью загрузки файлов, настройки параметров и просмотра
результатов в интерактивном режиме. Поддерживает множество форматов
входных файлов и различные варианты вывода.
