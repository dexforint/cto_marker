"""
Streamlit приложение для извлечения структурированных данных из документов.

Специализированное веб-интерфейс для извлечения данных из документов
согласно пользовательским схемам. Позволяет создавать и тестировать
схемы извлечения данных в интерактивном режиме.

Основные возможности:
- Создание пользовательских схем извлечения
- Тестирование схем на примерах документов
- Визуализация результатов извлечения данных
...
# Настройка переменных окружения для оптимизации работы в Streamlit
